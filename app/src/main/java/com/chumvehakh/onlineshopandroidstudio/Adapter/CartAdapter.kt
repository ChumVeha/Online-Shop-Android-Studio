package com.chumvehakh.onlineshopandroidstudio.Adapter
...
import com.chumvehakh.onlineshopandroidstudio.databinding.ViewholderCartBinding
...
class CartAdapter (private val listItemSelected:ArrayList<ItemsModel>,
    ...
    override fun onBindViewHolder(holder: CartAdapter.ViewHolder, position: Int) {
        ...
        holder.binding.feeEachltem.text = "$${item.price}"
        holder.binding.totalEachltem.text = "$${Math.round(item.numberInCart*item.price)}"
        holder.binding.numberltemTxt.text = item.numberInCart.toString()
