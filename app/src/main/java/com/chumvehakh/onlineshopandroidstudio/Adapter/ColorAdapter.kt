...
import com.chumvehakh.onlineshopandroidstudio.databinding.ViewholderBrandBinding
import com.chumvehakh.onlineshopandroidstudio.databinding.ViewholderColorBinding
...
class ColorAdapter (val items:MutableList<String>):
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        if (selectedPosition==position){
            ...
            holder.binding.colorLayout.setBackgroundResource(R.drawable.purple_bg)
        }
    }
